    ...
    <div className="container mx-auto px-4">
      <section className="hero-bg rounded-2xl p-8 md:p-12 mb-10 text-center overflow-hidden">
        <div className="hero-content max-w-3xl mx-auto relative z-20">
          ...
          <Link to="/chat" className="btn-primary inline-flex items-center hover-effect transition-all duration-300">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <a href="/documents" className="card block transform transition duration-500 hover:scale-105">
            <div className="p-6">
